...
The task: design and build a **memory service** for an AI agent. The service ingests conversation turns, persists them, extracts structured knowledge, and answers recall queries that decide what context the agent sees on the next turn.
